...
-   What if we know that males actually make up 50.8% of the population? Males are more likely to heary attacks
```{r}
...
Still using the heart attack data, is survival independent of gender? No
```{r}
